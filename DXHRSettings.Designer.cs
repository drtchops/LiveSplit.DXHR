namespace LiveSplit.DXHR
{
    partial class DXHRSettings
    {
        ...
        private void InitializeComponent()
        {
			...
			this.gbEndSplits.Size = new System.Drawing.Size(232, 297);
			...
			this.tlpEndSplits.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tlpEndSplits.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tlpEndSplits.Size = new System.Drawing.Size(226, 278);
			...
			this.chkFEMA.Location = new System.Drawing.Point(3, 72);
			...
			this.chkHengsha1.Location = new System.Drawing.Point(3, 95);
			...
			this.chkPicus.Location = new System.Drawing.Point(3, 164);
			...
			this.chkDetroit2.Location = new System.Drawing.Point(3, 187);
			...
			this.chkHengsha2.Location = new System.Drawing.Point(3, 210);
			...
			this.chkPanchaea.Location = new System.Drawing.Point(3, 256);
			...
			this.chkTaiYong1.Location = new System.Drawing.Point(3, 118);
			...
			this.chkTaiYong2.Location = new System.Drawing.Point(3, 141);
			...
			this.chkSingapore.Location = new System.Drawing.Point(3, 233);
			...
			this.gbStartSplits.Size = new System.Drawing.Size(232, 65);
			...
			this.tlpStartSplits.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tlpStartSplits.Size = new System.Drawing.Size(226, 46);
			...
			this.tlpMain.Controls.Add(this.gbDCEndSplits, 1, 1);
			...
			this.gbDCEndSplits.Controls.Add(this.tlpDCEndSplits);
			this.gbDCEndSplits.Dock = System.Windows.Forms.DockStyle.Fill;
			this.gbDCEndSplits.Location = new System.Drawing.Point(241, 74);
			this.gbDCEndSplits.Name = "gbDCEndSplits";
			this.gbDCEndSplits.Size = new System.Drawing.Size(232, 299);
			this.gbDCEndSplits.TabIndex = 8;
			this.gbDCEndSplits.TabStop = false;
			this.gbDCEndSplits.Text = "Director\'s Cut Splits";
			// 
			// tlpDCEndSplits
			// 
			this.tlpDCEndSplits.AutoSize = true;
			this.tlpDCEndSplits.BackColor = System.Drawing.Color.Transparent;
			this.tlpDCEndSplits.ColumnCount = 1;
			this.tlpDCEndSplits.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 100F));
			this.tlpDCEndSplits.Controls.Add(this.chkDC_TML_EndOfDLC, 0, 4);
			this.tlpDCEndSplits.Controls.Add(this.chkDC_TML_UnderwaterElevator, 0, 3);
			this.tlpDCEndSplits.Controls.Add(this.chkDC_TML_LeavingBoat, 0, 2);
			this.tlpDCEndSplits.Controls.Add(this.chkDCTongsEnd, 0, 0);
			this.tlpDCEndSplits.Dock = System.Windows.Forms.DockStyle.Fill;
			this.tlpDCEndSplits.Location = new System.Drawing.Point(3, 16);
			this.tlpDCEndSplits.Name = "tlpDCEndSplits";
			this.tlpDCEndSplits.RowCount = 6;
			this.tlpDCEndSplits.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tlpDCEndSplits.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 23F));
			this.tlpDCEndSplits.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tlpDCEndSplits.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tlpDCEndSplits.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 23F));
			this.tlpDCEndSplits.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tlpDCEndSplits.Size = new System.Drawing.Size(226, 280);
			this.tlpDCEndSplits.TabIndex = 0;
			// 
			// chkDC_TML_EndOfDLC
			// 
			this.chkDC_TML_EndOfDLC.AutoSize = true;
			this.chkDC_TML_EndOfDLC.Checked = true;
			this.chkDC_TML_EndOfDLC.CheckState = System.Windows.Forms.CheckState.Checked;
			this.chkDC_TML_EndOfDLC.Location = new System.Drawing.Point(3, 95);
			this.chkDC_TML_EndOfDLC.Name = "chkDC_TML_EndOfDLC";
			this.chkDC_TML_EndOfDLC.Size = new System.Drawing.Size(120, 17);
			this.chkDC_TML_EndOfDLC.TabIndex = 4;
			this.chkDC_TML_EndOfDLC.Text = "TML - Finished DLC";
			this.chkDC_TML_EndOfDLC.UseVisualStyleBackColor = true;
			// 
			// chkDC_TML_UnderwaterElevator
			// 
			this.chkDC_TML_UnderwaterElevator.AutoSize = true;
			this.chkDC_TML_UnderwaterElevator.Checked = true;
			this.chkDC_TML_UnderwaterElevator.CheckState = System.Windows.Forms.CheckState.Checked;
			this.chkDC_TML_UnderwaterElevator.Location = new System.Drawing.Point(3, 72);
			this.chkDC_TML_UnderwaterElevator.Name = "chkDC_TML_UnderwaterElevator";
			this.chkDC_TML_UnderwaterElevator.Size = new System.Drawing.Size(154, 17);
			this.chkDC_TML_UnderwaterElevator.TabIndex = 3;
			this.chkDC_TML_UnderwaterElevator.Text = "TML - Underwater Elevator";
			this.chkDC_TML_UnderwaterElevator.UseVisualStyleBackColor = true;
			// 
			// chkDC_TML_LeavingBoat
			// 
			this.chkDC_TML_LeavingBoat.AutoSize = true;
			this.chkDC_TML_LeavingBoat.Checked = true;
			this.chkDC_TML_LeavingBoat.CheckState = System.Windows.Forms.CheckState.Checked;
			this.chkDC_TML_LeavingBoat.Location = new System.Drawing.Point(3, 49);
			this.chkDC_TML_LeavingBoat.Name = "chkDC_TML_LeavingBoat";
			this.chkDC_TML_LeavingBoat.Size = new System.Drawing.Size(120, 17);
			this.chkDC_TML_LeavingBoat.TabIndex = 2;
			this.chkDC_TML_LeavingBoat.Text = "TML - Leaving Boat";
			this.chkDC_TML_LeavingBoat.UseVisualStyleBackColor = true;
			// 
			// chkDCTongsEnd
			// 
			this.chkDCTongsEnd.AutoSize = true;
			this.chkDCTongsEnd.Checked = true;
			this.chkDCTongsEnd.CheckState = System.Windows.Forms.CheckState.Checked;
			this.chkDCTongsEnd.Location = new System.Drawing.Point(3, 3);
			this.chkDCTongsEnd.Name = "chkDCTongsEnd";
			this.chkDCTongsEnd.Size = new System.Drawing.Size(138, 17);
			this.chkDCTongsEnd.TabIndex = 0;
        ...
        private System.Windows.Forms.CheckBox chkDCTongsEnd;
        private System.Windows.Forms.CheckBox chkDC_TML_EndOfDLC;
        private System.Windows.Forms.CheckBox chkDC_TML_UnderwaterElevator;
        private System.Windows.Forms.CheckBox chkDC_TML_LeavingBoat;
		private System.Windows.Forms.GroupBox groupBox1;
		private System.Windows.Forms.TableLayoutPanel tableLayoutPanel1;
		private System.Windows.Forms.CheckBox chkDC_Option_DisableFocusLoss;
	}
}
